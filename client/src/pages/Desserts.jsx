...
function ShelfSection({ label, items, onAddToCart }) {
    return (
...
function Desserts() {
    ...
    return (
        <div className="desserts-page">
            ...
            {/* Toast */}
            {toast && <div className="dessert-toast">{toast}</div>}

            <h1 className="desserts-title">✨ Desserts ✨</h1>
            <ShelfSection label="🥞 Pancakes" items={pancakes} onAddToCart={handleAddToCart} />
            <ShelfSection label="🥐 Baked Goods" items={baked_goods} onAddToCart={handleAddToCart} />
            <ShelfSection label="🎂 Small Cakes" items={small_cakes} onAddToCart={handleAddToCart} />
            <ShelfSection label="🍮 Jellies" items={jellies} onAddToCart={handleAddToCart} />
            <ShelfSection label="🍯 Pots" items={pots} onAddToCart={handleAddToCart} />
        </div>
    );
}
